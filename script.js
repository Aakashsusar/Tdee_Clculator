...
function calculateBmi() {
  ...
  if (roundedBmi < 18.5) {
    messageOutput.innerHTML = "Underweight (You need to see doctor..Gain your weight)";
  } else if (roundedBmi< 25) {
    messageOutput.innerHTML= "Normal weight (You are fit good...)";
  } else if (roundedBmi< 30) {
    messageOutput.innerHTML = "Overweight (Start Workout)";
  } else {
    messageOutput.innerHTML = "Obesse (You need to workout)";
  }
}